# @phaeton/phaeton-cryptography

@phaeton/phaeton-cryptography is containing general cryptographic functions for use with Phaeton-related software

## Installation

```sh
$ npm install --save @phaeton/phaeton-cryptography
```
