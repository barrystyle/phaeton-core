...
const getSigningBytes = (assetSchema, transactionObject) => {
    ...
    const assetBytes = phaeton_codec_1.codec.encode(assetSchema, transactionObject.asset);
    const transactionBytes = phaeton_codec_1.codec.encode(schema_1.baseTransactionSchema, {
        ...transactionObject,
        asset: assetBytes,
        signatures: [],
    });
...
const signTransaction = (assetSchema, transactionObject, networkIdentifier, passphrase) => {
    ...
    const signature = phaeton_cryptography_1.signData(transactionWithNetworkIdentifierBytes, passphrase);
    transactionObject.signatures = [signature];
    return { ...transactionObject, id: phaeton_cryptography_1.hash(exports.getBytes(assetSchema, transactionObject)) };
};
