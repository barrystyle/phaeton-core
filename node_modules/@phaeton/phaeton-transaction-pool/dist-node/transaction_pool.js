...
const debug = createDebug('phaeton:transaction_pool');
...
class TransactionPool {
    constructor(config) {
        ...
        this._feePriorityQueue = new phaeton_utils_1.dataStructures.MinHeap();
        this._allTransactions = new phaeton_utils_1.dataStructures.BufferMap();
        this._transactionList = new phaeton_utils_1.dataStructures.BufferMap();
    ...
    async add(incomingTx) {
        ...
        const incomingTxAddress = phaeton_cryptography_1.getAddressFromPublicKey(incomingTx.senderPublicKey);
        let txStatus;
        try {
    ...
    remove(tx) {
        ...
        const senderId = phaeton_cryptography_1.getAddressFromPublicKey(foundTx.senderPublicKey);
    ...
    getProcessableTransactions() {
        const processableTransactions = new phaeton_utils_1.dataStructures.BufferMap();
    ...
    _evictUnprocessable() {
        const unprocessableFeePriorityHeap = new phaeton_utils_1.dataStructures.MinHeap();
    ...
    _evictProcessable() {
        const processableFeePriorityHeap = new phaeton_utils_1.dataStructures.MinHeap();
        for (const txList of this._transactionList.values()) {
