...
#
# Unless otherwise agreed in a custom licensing agreement with the Phaeton Pty Ltd.,
...
info:
  title: Phaeton API documentation
  description: |
    # Welcome!
    ...
    ```
    ## List of endpoints
    All possible API endpoints for Phaeton Core are listed below.
  ...
  /forging:
    patch:
      ...
      description: |
        ...
        The password can be generated locally by encrypting your passphrase, either by using Phaeton Wingman or with Phaeton Backbone.
      produces:
        - application/json
      consumes:
        - application/json
...
definitions:
      ...
      token:
        ...
        properties:
          balance:
            ...
            description: The current balance of the account in Helis.
      sequence:
        type: object
        required:
          - nonce
  ...
  BlockHeader:
    ...
    properties:
      ...
      version:
        type: number
        description: Versioning for future upgrades of the Phaeton protocol.
      timestamp:
        type: number
  ...
  Peer:
    ...
    properties:
      ...
      networkVersion:
        type: string
        example: 1.1
        description: The protocol version of Phaeton Core that the peer node runs on.
      networkIdentifier:
        type: string
    ...
    properties:
      ...
      genesisConfig:
        ...
        properties:
          ...
          totalAmount:
            type: string
            description: Total amount of PHAE available in network before rewards milestone started
