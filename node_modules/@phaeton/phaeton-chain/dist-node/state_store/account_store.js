...
class AccountStore {
    constructor(dataAccess, additionalInformation) {
        ...
        this._data = new phaeton_utils_1.dataStructures.BufferMap();
        this._updatedKeys = new phaeton_utils_1.dataStructures.BufferSet();
        this._deletedKeys = new phaeton_utils_1.dataStructures.BufferSet();
        this._originalData = new phaeton_utils_1.dataStructures.BufferMap();
        this._originalUpdatedKeys = new phaeton_utils_1.dataStructures.BufferSet();
        this._originalDeletedKeys = new phaeton_utils_1.dataStructures.BufferSet();
        this._defaultAccount = additionalInformation.defaultAccount;
        this._initialAccountValue = new phaeton_utils_1.dataStructures.BufferMap();
    }
    createSnapshot() {
    ...
    async get(address) {
        ...
        if (cachedAccount) {
            return phaeton_utils_1.objects.cloneDeep(cachedAccount);
        }
        if (this._deletedKeys.has(address)) {
            throw new phaeton_db_1.NotFoundError(`Account ${address.toString('hex')} has been deleted`);
        }
    ...
    async getOrDefault(address) {
        ...
        const defaultAccount = {
            address,
            ...phaeton_utils_1.objects.cloneDeep(this._defaultAccount),
        };
    ...
    _getAccountInstance(encodedAccount) {
        ...
        return phaeton_utils_1.objects.cloneDeep(decodedAccount);
    }
}
