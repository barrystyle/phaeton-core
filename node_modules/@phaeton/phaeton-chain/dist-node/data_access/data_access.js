...
class DataAccess {
    ...
    decode(buffer) {
        const block = phaeton_codec_1.codec.decode(schema_1.blockSchema, buffer);
    ...
    encode(block) {
        ...
        return phaeton_codec_1.codec.encode(schema_1.blockSchema, { header, payload });
    }
    ...
    decodeAccount(buffer) {
        return phaeton_codec_1.codec.decode(this._accountSchema, buffer);
    }
    encodeAccount(account) {
        return phaeton_codec_1.codec.encode(this._accountSchema, account);
    }
