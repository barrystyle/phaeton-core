...
class MerkleTree {
    ...
    generateProof(queryData) {
        ...
        const path = [];
        const addedPath = new phaeton_utils_1.dataStructures.BufferSet();
        const indexes = [];
        let queryNode;
    ...
    _generateLeaf(value, nodeIndex) {
        ...
        const leafHash = this._preHashedLeaf ? value : phaeton_cryptography_1.hash(leafValueWithoutNodeIndex);
