        ...
        const data = [
            {
                ...
                metric: 'phaeton_avg_times_blocks_received_info',
                values: [
                    {
                        key: '',
            ...
            },
            {
                ...
                type: PROMETHEUS_TYPE.gauge,
                metric: 'phaeton_avg_times_transactions_received_info',
                values: [
                    {
                        key: '',
            ...
            },
            {
                label: 'Node Height',
                type: PROMETHEUS_TYPE.gauge,
                metric: 'phaeton_node_height_total',
                values: [
                    {
                        key: '',
            ...
            },
            {
                ...
                type: PROMETHEUS_TYPE.gauge,
                metric: 'phaeton_finalized_height_total',
                values: [
                    {
                        key: '',
            ...
            },
            {
                ...
                type: PROMETHEUS_TYPE.gauge,
                metric: 'phaeton_unconfirmed_transactions_total',
                values: [
                    {
                        key: '',
            ...
            },
            {
                label: 'Fork events',
                type: PROMETHEUS_TYPE.gauge,
                metric: 'phaeton_fork_events_total',
                values: [
                    {
                        key: '',
