...
const debug = createDebug('phaeton:bft:consensus_manager');
...
exports.BFTVotingLedgerSchema = {
    type: 'object',
    $id: '/bft/validators',
    title: 'Phaeton BFT Validator ledger',
...
phaeton_codec_1.codec.addSchema(exports.BFTVotingLedgerSchema);
class FinalityManager extends events_1.EventEmitter {
    ...
    async updatePrevotesPrecommits(header, stateStore, bftBlockHeaders) {
        ...
        const generatorAddress = phaeton_cryptography_1.getAddressFromPublicKey(generatorPublicKey);
        const validators = await phaeton_chain_1.getValidators(stateStore);
    ...
    _decodeVotingLedger(bftVotingLedgerBuffer) {
        const votingLedger = bftVotingLedgerBuffer === undefined
            ...
            : phaeton_codec_1.codec.decode(exports.BFTVotingLedgerSchema, bftVotingLedgerBuffer);
        ...
        const validators = votingLedger.validators.reduce((prev, curr) => {
            ...
            return prev;
        }, new phaeton_utils_1.dataStructures.BufferMap());
    ...
    async _setVotingLedger(stateStore, votingLedgerMap) {
        ...
        await stateStore.consensus.set(exports.CONSENSUS_STATE_VALIDATOR_LEDGER_KEY, phaeton_codec_1.codec.encode(exports.BFTVotingLedgerSchema, {
