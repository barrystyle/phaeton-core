...
exports.BFTFinalizedHeightCodecSchema = {
    ...
    title: 'Phaeton BFT Finalized Height',
    properties: {
        finalizedHeight: {
            dataType: 'uint32',
            fieldNumber: 1,
...
phaeton_codec_1.codec.addSchema(exports.BFTFinalizedHeightCodecSchema);
class BFT extends events_1.EventEmitter {
    ...
    async applyBlockHeader(block, stateStore) {
        ...
        await stateStore.consensus.set(phaeton_chain_1.CONSENSUS_STATE_FINALIZED_HEIGHT_KEY, phaeton_codec_1.codec.encode(exports.BFTFinalizedHeightCodecSchema, { finalizedHeight }));
    }
    ...
    async _initFinalityManager(stateStore) {
        const storedFinalizedHeightBuffer = await stateStore.consensus.get(phaeton_chain_1.CONSENSUS_STATE_FINALIZED_HEIGHT_KEY);
        const finalizedHeight = storedFinalizedHeightBuffer === undefined
            ? this.constants.genesisHeight
            : phaeton_codec_1.codec.decode(exports.BFTFinalizedHeightCodecSchema, storedFinalizedHeightBuffer).finalizedHeight;
