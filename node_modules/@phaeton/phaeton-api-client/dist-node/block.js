...
class Block {
    ...
    toJSON(block) {
        ...
        const header = {
            ...phaeton_codec_1.codec.toJSON(this._schemas.blockHeader, headerRoot),
            asset: {},
            id: tmpBlockId === null || tmpBlockId === void 0 ? void 0 : tmpBlockId.toString('hex'),
        };
        const headerAssetJson = phaeton_codec_1.codec.toJSON(this._schemas.blockHeadersAssets[block.header.version], asset);
        ...
        for (const tx of block.payload) {
            ...
            const jsonTxRoot = phaeton_codec_1.codec.toJSON(this._schemas.transaction, txRoot);
            const jsonTx = {
                ...jsonTxRoot,
    ...
    fromJSON(block) {
        ...
        delete headerRoot.id;
        const header = {
            ...phaeton_codec_1.codec.fromJSON(this._schemas.blockHeader, headerRoot),
            asset: {},
            id: tmpBlockId,
        };
        const headerAssetJson = phaeton_codec_1.codec.fromJSON(this._schemas.blockHeadersAssets[block.header.version], asset);
        header.asset = headerAssetJson;
        const payload = [];
        for (const tx of block.payload) {
            const { asset: txAsset, ...txRoot } = tx;
            ...
            const txRootObject = phaeton_codec_1.codec.fromJSON(this._schemas.transaction, txRoot);
            const txObject = {
                ...txRootObject,
                id: tmpId,
                asset: txAssetObject,
