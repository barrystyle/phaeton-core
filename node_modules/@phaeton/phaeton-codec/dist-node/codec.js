...
const validateSchema = (schema) => {
    var _a;
    phaeton_validator_1.validator.removeSchema(schema.$id);
    const schemaToValidate = {
        ...schema,
        $schema: (_a = schema.$schema) !== null && _a !== void 0 ? _a : phaeton_validator_1.phaetonSchemaIdentifier,
    };
    const errors = phaeton_validator_1.validator.validateSchema(schemaToValidate);
    if (errors.length) {
        throw new phaeton_validator_1.PhaetonValidationError([...errors]);
    }
    try {
        phaeton_validator_1.validator.compile(schemaToValidate);
    }
    finally {
        phaeton_validator_1.validator.removeSchema(schema.$id);
    }
...
class Codec {
    ...
    toJSON(schema, message) {
        const messageCopy = phaeton_utils_1.objects.cloneDeep(message);
