...
class Peer extends events_1.EventEmitter {
    ...
    async fetchPeers() {
        try {
            ...
            const { peers } = phaeton_codec_1.codec.decode(this._rpcSchemas.peerRequestResponse, response.data);
            const sanitizedPeersList = peers.map((peerInfoBuffer) => {
                const peerInfo = phaeton_codec_1.codec.decode(this._rpcSchemas.peerInfo, peerInfoBuffer);
