...
const getBucketId = (options) => {
    ...
    if (network !== NETWORK.NET_IPV4) {
        return phaeton_cryptography_1.hash(Buffer.concat([secretBytes, networkBytes])).readUInt32BE(0) % bucketCount;
    }
    ...
    return phaeton_cryptography_1.hash(bucketBytes).readUInt32BE(0) % bucketCount;
};
