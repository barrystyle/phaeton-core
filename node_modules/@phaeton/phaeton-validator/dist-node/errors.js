...
exports.PhaetonValidationError = void 0;
...
class PhaetonValidationError extends Error {
    constructor(errors) {
        super();
        this.errors = errors;
        this.message = `Phaeton validator found ${this.errors.length} error[s]:\n${this._compileErrors().join('\n')}`;
    }
    _compileErrors() {
...
exports.PhaetonValidationError = PhaetonValidationError;
