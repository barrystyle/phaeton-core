# Contributing to Phaeton Core

First off, thanks for taking the time to contribute! :raised_hands:

The following is a set of guidelines for contributing to Phaeton Core, which
are hosted in the [Phaeton-Blockchain Organization](https://github.com/Phaeton-Blockchain]) on GitHub.
...
[Phaeton Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are
expected to uphold this code. Please report unacceptable behavior to
[info@phaeton.io](mailto:info@phaeton.io).

## Project License

Every repository within Phaeton-Blockchain comes with a LICENSE file. Please read it
...
If you prefer to chat with Phaeton-Blockchain and other developers directly:

- [Join the Phaeton-Blockchain Telegram](https://t.me/joinchat/bXDLcx5MKYwwNjg9)
...
Phaeton-Blockchain uses GitHub as its sole source of truth. Everything happens here.
In other words, this document applies equally to all contributors.
...
1. Ensure the test and linting suites pass. Follow the
   ...
   with the [phaeton extension](https://github.com/Phaeton-Blockchain/eslint-config-phaeton-base).
...
This section guides you through submitting a bug report for Phaeton Core.
...
- **Determine
  [which repository the problem should be reported in](https://github.com/Phaeton-Blockchain)**.
- **Perform a
  [cursory search](https://github.com/search?utf8=%E2%9C%93&q=+is%3Aissue+org%3Phaeton-Blockchain&type=)**
...
After you’ve determined [which repository](https://github.com/Phaeton-Blockchain) your bug
...
- **Did the problem start happening recently** (e.g. after updating to a new
  version of Phaeton Core, Phaeton or any other repository) or was this always a
  problem?
- If the problem started happening recently, **can you reproduce the problem in
  an older version of Phaeton Core?** What’s the most recent version in which
  the problem doesn’t happen? You can download older versions of Phaeton Core
  from [the releases page](https://github.com/Phaeton-Blockchain/plaak-phaeton-core/releases).
...
Phaeton Core, including completely new features and minor improvements to
...
determined [which repository](https://github.com/Phaeton-Blockchain) your enhancement
...
- **Include screenshots and animated GIFs** which help you demonstrate the steps
  or point out the part of Phaeton Core which the suggestion is related to. You
...
- **Explain why this enhancement would be useful** to most Phaeton and
  Phaeton Core users.
- **Specify which version of Phaeton and Phaeton Core you’re using.**
...
On Phaeton we are using [Prettier](https://prettier.io/) and
...
details here: https://github.com/Phaeton-Blockchain/eslint-config-phaeton-base
